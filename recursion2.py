#  File: recursion2.py
#  Description: This program solves given problems recusively.
#  Student Name: Sahil Shah
#  Student UT EID: sbs2756
#  Partner's Name: Alexandra Brown
#  Partner's UT EID: asb3456
#  Course Name: CS 313E
#  Unique Number: 50205
#  Date Created: 2 October 2019
#  Date Last Modified: 7 October 2019
...
def groupSum(start, nums, target):
    if start >= len(nums):
        ...
        #Either subtract or don't from target
...
def groupNoAdj(start, nums, target):
    if start >= len(nums):
        ...
        #If chosen skip next value, if not chosen proceed to next value
...
def splitArray(nums):
    array1 = []
    array2 = []
    splitArrayHelper(nums, array1, array2, 0)
    result = False
    nums_sum = sum(nums)
    for val in array2:
        if (nums_sum - val == val):
...
def splitArrayHelper(a1, a2, a3, index):
    if (index == len(a1)):
        n_sum = sum(a2)
        a3.append(n_sum)
        return
        ...
        a4 = a2[:]
        a2.append(a1[index])
        splitArrayHelper(a1, a2, a3, index+1)
        splitArrayHelper(a1, a4, a3, index+1)
...
def splitOdd10(nums):
    array1 = []
    array2 = []
    splitOdd10Helper(nums, array1, array2, 0)
    result = False
    nums_sum = sum(nums)
    if (nums_sum % 2 == 1):
        result = True
...
def splitOdd10Helper(a1, a2, a3, index):
    if (index == len(a1)):
        n_sum = sum(a2)
        a3.append(n_sum)
        return
        ...
        a4 = a2[:]
        a2.append(a1[index])
        splitOdd10Helper(a1, a2, a3, index + 1)
        splitOdd10Helper(a1, a2, a3, index + 1)
...
def split53(nums):
    ...
    array2 = []
    not_common = []
    split53Helper(nums, array1, array2, 0)
    result = False
    nums_sum = sum(nums)
    for i in range(0, len(array2)):
        if (array2[i] % 5 == 0 and array2[i] % 3 == 0):
            not_common.append(array2[i])
        if (array2[i] % 5 != 0 or array2[i] % 3 != 0):
            not_common.append(array2[i])
    for val in not_common:
        if (nums_sum - val == val):
            result = True
    return result


def split53Helper(a1, a2, a3, index):
    if (index == len(a1)):
        n_sum = sum(a2)
        a3.append(n_sum)
        return
        ...
        a4 = a2[:]
        a2.append(a1[index])
        split53Helper(a1, a2, a3, index + 1)
        split53Helper(a1, a4, a3, index + 1)

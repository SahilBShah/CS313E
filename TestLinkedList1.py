...
#  Date Last Modified: 31 October 2019
...
class LinkedList():
    ...
    def merge_list(self, other):
        ...
        tmp_list1.append(current1.data)
        tmp_list2.append(current2.data)
        ...
        if current2.next != None:
            for i in range(1, count2):
                if current2.next != None:
                    ...
                    tmp_list2.append(current2.data)
        merge_list = tmp_list1 + tmp_list2
        merge_list.sort()
        new_list.insert_first(merge_list[0])
        for j in range(1, len(merge_list)):
            new_list.insert_last(merge_list[j])
        return new_list
